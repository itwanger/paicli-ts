...
- OpenAI-compatible LLM 客户端，可适配 DeepSeek、GLM、OpenAI 兼容接口。
...
PAICLI_MODEL=gpt-4.1
PAICLI_BASE_URL=https://api.openai.com/v1
PAICLI_API_KEY=your_api_key
```
...
```bash
pnpm paicli --provider openai --model gpt-4.1 -p "hello"
```
